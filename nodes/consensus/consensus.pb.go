...
type VoteResponse struct {
	...
	VoteSignature string `protobuf:"bytes,4,opt,name=vote_signature,json=voteSignature,proto3" json:"vote_signature,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *VoteResponse) GetVoteSignature() string {
	if x != nil {
...
const file_consensus_proto_rawDesc = "" +
	...
	"\x0esigned_message\x18\x06 \x01(\tR\rsignedMessage\"\x80\x01\n" +
	"\fVoteResponse\x12\x17\n" +
	"\anode_id\x18\x01 \x01(\tR\x06nodeId\x12\x18\n" +
	"\aapprove\x18\x02 \x01(\bR\aapprove\x12\x16\n" +
	"\x06reason\x18\x03 \x01(\tR\x06reason\x12%\n" +
	"\x0evote_signature\x18\x04 \x01(\tR\rvoteSignature\"7\n" +
	"\rCommitRequest\x12&\n" +
