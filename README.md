...
┌─────────────────────────────────────────────────────────┐
│                 Azure AD / External IDP                 │
│               (ספק הזהות החיצוני - נותן האמון)          │
└───────────────────────────┬─────────────────────────────┘
                            │
                  TRUSTS / נותן אמון ב-
                            ▼
┌─────────────────────────────────────────────────────────┐
│               Keycloak (כ-OAuth2 Client)                │
│                 (מקבל האמון / מתווך)                    │
└───────────────────────────┬─────────────────────────────┘
                            │
               מנגנוני ביסוס האמון (Trust Basis)
                            ▼
┌─────────────────────────────────────────────────────────┐
│ 1. רישום: Keycloak חייב להיות רשום כ-App ב-Azure AD     │
├─────────────────────────────────────────────────────────┤
│ 2. הזדהות: שימוש ב- client_id + client_secret           │
│    (או במנגנון PKCE לאבטחה מוגברת)                      │
├─────────────────────────────────────────────────────────┤
│ 3. אימות ניתוב: redirect_uri מוגדר ומאושר מראש          │
│    (https://keycloak.../broker/{alias}/endpoint)        │
├─────────────────────────────────────────────────────────┤
│ 4. תשתית: כלל התהליך מבוסס על תקשורת מוצפנת (TLS)       │
└─────────────────────────────────────────────────────────┘
